...
interface Pr000xyInterface {
     ...
     */
    event ProxyCreated(address indexed creator, uint256 indexed value, address proxy);
     ...
     */
    event ProxyClaimed(address indexed claimant, uint256 indexed value, address proxy);
     ...
     * @param proxy address Address of the created proxy.
     */
    event ProxyCreatedAndClaimed(address indexed creator, address proxy);
     ...
     */
    event OfferCreated(uint256 indexed offerID, address indexed offerer, uint256 reward);
     ...
     */
    event OfferFulfilled(uint256 indexed offerID, address indexed offerer, address indexed submitter, uint256 reward);
     ...
     */
    event OfferSetToExpire(uint256 indexed offerID, address indexed offerer, uint256 expiration);
     ...
     */
    function scheduleOfferExpiration(uint256 offerID) external returns (uint256 expiration);
